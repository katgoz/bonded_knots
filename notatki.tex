...
\begin{verbatim}
W katalogu 9 jest podział na grupy z 1 grafem lub kilkoma, wewnątrz tego są foldery: "8w"-grupę można uprościć do 8w, "to samo"-albo nie da się nic zrobić albo część da się uprościć do 8w i pozostałe to ten sam 9w, "+1" - dla danego wielomianu yamady są 2 różne grupy
